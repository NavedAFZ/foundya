class ApplicantsController < ApplicationController
  ...
  def check
     ...
     if current_user.applicants.count>=1
     redirect_to applicants_path, notice: "Allready created" 
     end
  end
  def correct_user
  ...
  private
    ...
    def applicant_params
      params.require(:applicant).permit(:name,:email, :github_url, :linked_in, :cv_url, :description, :skill1, :skill2, :skill3, :project1, :project1_url, :project2, :project2_url, :project3, :project3_url, :experience1, :experience2, :experience3, :user_id)
    end
end
